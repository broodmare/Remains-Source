package src {
	...
	public class MainMenu {
		...
		var version:String='1.0.3 (woons)';
		var mm:MovieClip; // Create MovieClip object for MainMenu
		...
		public function funOverSlot(event:MouseEvent) {
			src.inter.PipPageOpt.showSaveInfo(arr[event.currentTarget.id.text],mm.dialLoad);
		}
