package systems
{
    ...
    public class TileFilter
    {
        ...
        private static function tileFilterSetup():void
		{
            ...
            trace('TileFilter.as/tileFilterSetup() - tileFilter object list is being created and intialized.');
            tileFilter = {};
            ...
            {
                trace('TileFilter.as/tileFilterSetup() - Error encountered while setting up the tileFilter. Error: "' + err.message + '."');
            }
		}
    }
}