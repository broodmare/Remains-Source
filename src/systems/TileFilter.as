package systems
{
    ...
    {
        public static var tileFilter:Object = {};


        public function TileFilter()
        {
            tileFilterSetup();
            trace('Tilefilter setup.');
        }
        ...
        public static function getFilter(filterName:String):Array 
        {
            ...
            {
                trace('Could not return tileFiler: ', filterName, '\n' + err.message);
            }
        ...
        private static function tileFilterSetup():void
		{
            ...
            {
                trace('Error encountered while setting up the tileFilter.\n' + err.message);
            }
		}
    }
}